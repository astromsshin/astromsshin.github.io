...
wget 'http://skyservice.pha.jhu.edu/DR10/ImgCutout/getjpeg.aspx?ra='$useRA'&dec='$useDEC'&scale=0.5020920&width=293&height=293&opt=GS&query=&Grid=on&PhotoObjs=on' -O $useOutFN
